...
const TOGGLES = [
  {
    ...
    description: "Get notified when it's time to post and on other updates.",
    defaultValue: true,
  },
  {
    key: "reminders",
    label: "Daily Reminder",
    description: "A reminder to post before your daily moment expires.",
    defaultValue: true,
  },
  {
    key: "reactions",
    label: "Comments & Reactions",
    description: "Get notified when someone comments or reacts to your post.",
    defaultValue: true,
  },
  {
    key: "friends",
    label: "Friend Activity",
    description: "New friend requests and friends joining the app.",
    defaultValue: false,
  },
] as const;
